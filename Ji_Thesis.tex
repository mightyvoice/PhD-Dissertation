...
For energy detection, an SU calculates the energy of the signal received from
a channel.  
...
In a CRN, two SUs should only communicate through a channel which is available to both simultaneously to avoid the interference to PUs. We call this kind of channel the common available channel. A communicating SU pair could have several  common available channels at a specific time.  If the current occupied common available channel suddenly becomes unavailable for one or both of the two SUs, in order to finish the current transmission, the two SUs should hop to the next common available channel. The process of vacating the currently  
using channel and then switching to a new available channel is called \textit{spectrum handoff} \cite{iAkyildiz06NGDSA}. 
...
\begin{figure}[hbtp] 
    \begin{center} 
        \includegraphics[width=12cm,height=8cm]{ResearchOverview.jpg} 
...
\label{char:PR}
In this chapter, we propose five schemes considering rendezvous in wide-band CRNs, rendezvous without a predetermined sender
...
\subsection{Unaligned Time Slots}
...
\begin{figure}[hbtp] 
    \begin{center} 
        \includegraphics[width=7cm,height=2.3cm]{sec_3_1-unaligned1.jpg} 
...
\begin{figure}[hbtp] 
    \begin{center} 
        \includegraphics[width=7cm,height=2.3cm]{sec_3_1-unaligned2.jpg} 
...
\begin{figure}[hbtp] 
    \begin{center} 
        \includegraphics[width=7cm,height=2.3cm]{sec_3_1-unaligned3.jpg} 
...
\begin{figure}[hbtp] 
    \begin{center} 
        \includegraphics[width=7cm,height=2.3cm]{sec_3_1-unaligned4.jpg} 
...
\subsection{The Optimal Time Slot Length}
...
\begin{figure}[hbt]
\begin{center}
\includegraphics[width=8cm,height=3cm]{sec_3_1-optTimeSlot1.jpg}
...
\begin{figure}[hbt]
\begin{center}
\includegraphics[width=8cm,height=3cm]{sec_3_1-optTimeSlot2.jpg}
...
\subsubsection{The \textit{ETTR}  of Rendezvous under the Symmetrical Model}
...
\subsubsection{The \textit{ETTR}  of Rendezvous under the Asymmetrical Model}
...
\begin{figure}[hbtp] 
    \begin{center} 
      \includegraphics[width=10cm,height=8cm]{sec_3_1-com_avai_fac.eps} 
      \caption{The \textit{ETTR} under different common available ratio.}
    \label{fig:com_avai_fac} 
    \end{center}   
\end{figure} 

\subsubsection{The Time for Information Exchange}
...
\subsubsection{The Average Normalized Throughput}
...
\subsubsection{The Effect of the Value of $\theta$}
...
\subsubsection{The impact of the number of total channels}
...
In Fig. \ref{fig:rend1},  we show the average time to a \textit{link rendezvous} by implementing the
...
\subsubsection{The impact of the channel available ratio}
...
\subsubsection{The impact of the number of cognitive radios}
...
\section{Rendezvous Schemes Without Predetermined Send and Receiver Considering a Single Radio}
...
our simulations are shown in Table \ref{table:parameters}.
\begin{table}[htb]
...
\subsubsection{Average Link Rendezvous Time Under Different Scenarios}
...
%\end{figure}
 
\subsubsection{Link Rendezvous Successful Ratio}
...
\label{table:parameters} 
\end{table}
\subsubsection{Performance of the Sector Rendezvous Schemes}
...
\end{figure}
 
\subsubsection{Average Time Slots to Successfully Set Up a Link}
...
\subsection{Analysis of the Sensing Range of an SU Sender} 
\vspace{-0.2cm} The requirement that an SU sender can sense whether there is an interfering transmission  
...
\vspace{-0.2cm} For an SU, a larger sensing range means more unavailable channels and less available  
...
\vspace{-0.2cm} The sensing range of an SU will directly affect the number of its individual available channels.  
...
are listed in Table \ref{table:parameters}. 
